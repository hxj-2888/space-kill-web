...
children.push(
  ...
  bullet('v26~v29 时代的 12 份历史文档（v26 全面修复说明 / 通道接线进度与口径 / v27 交接文档与模块化解耦 / v27 与 v28 未修复点清单 / v28 修复说明与可行性审查 / AI 与推理层全面审查 / v29 方案可行性审查 / 早期对齐审查报告与改动方案）已移出 docs/，归档于 C:/Users/ASUS/CodeBuddy/20260910112441/_archive_docs_v26-v29/（含 改动说明 与 README 的历史全文）。'),
